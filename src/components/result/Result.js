...
import WarningGif from "../../assets/download.png";
import SafeGif from "../../assets/safe0.png";
  ...
  return (
    ...
    <h1 className="font-semibold text-center max-sm:text-xl sm:text-2xl "> "{input_url}" </h1>
      ...
      <h1 className="font-light text-center mt-3 max-sm:text-lg sm:text-2xl md:text-3xl ">
        There is <span className="font-extrabold"> {url_score} % </span> chance URL is malicious!
      </h1>
